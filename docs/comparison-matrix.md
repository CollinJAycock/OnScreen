...
| H.264 encode (QSV)             | ✅ | 💎 | 💎 | ✅ | Validated 2026-04-30 on Raptor Lake-HX UHD Graphics (i9-13900HX iGPU) end-to-end via the OnScreen worker — 4K AV1 SDR → 1080p H.264 and 4K HEVC HDR10 → zscale tonemap → 1080p H.264. Real-content sessions, not probe-only |
