...
//
// webOS TVs decode H.264 and HEVC (including Main 10 / 4K HDR) and AAC/AC-3/
// E-AC-3 natively via the hardware media pipeline; AV1 support varies by model
// and is not claimed. The behaviorally-significant fields here (HEVC + the 5.1
