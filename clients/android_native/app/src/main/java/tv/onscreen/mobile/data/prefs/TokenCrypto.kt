    ...
    private fun generateKey(): SecretKey {
        ...
        gen.init(
            KeyGenParameterSpec.Builder(
                ...
                .setKeySize(256)
                // No user-auth requirement: the background download worker and the
                // token-refresh path must read tokens without a biometric prompt,
                // and a lock-screen change must not invalidate them.
                .build(),
        )
