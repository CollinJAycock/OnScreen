...
class ServerPrefs(private val context: Context) {
    ...
    companion object {
        ...
        // ExoPlayer / Coil / the download worker can't attach an
        // Authorization header to. The server rejects the general
        // access token in a URL, so artwork/stream/subtitle/SSE URLs
        // use this instead.
