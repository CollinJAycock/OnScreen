...
/** The heartbeat-refusal decision shared by ProgressTracker (foreground) and
 *  OnScreenMediaSessionService (background audio). Kept in step with the
 *  phone client's HeartbeatRefusalTest. */
