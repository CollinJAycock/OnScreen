<script lang="ts">
  ...
  let name = '';
  let type: 'movie' | 'show' | 'music' | 'photo' | 'dvr' | 'audiobook' | 'podcast' = 'movie';
  let paths: string[] = [''];
  let agent = 'tmdb';
  let language = 'en';
  ...
  <form on:submit|preventDefault={submit}>
    <section class="section">
      ...
      <div class="type-picker">
        {#each [['movie','🎬','Movies'],['show','📺','TV Shows'],['music','🎵','Music'],['audiobook','🎧','Audiobooks'],['podcast','🎙️','Podcasts'],['photo','🖼️','Photos'],['dvr','📼','DVR Recordings']] as [val, icon, label]}
